...
function checkVocabulary(tdJson) {
    ...
    */
    ...
    var valid = ajv.validate('td', tdJson);
    var otherAssertions = ["td-objects:securityDefinitions", "td-arrays:security", "td-security", "td-security-mandatory", "td-vocab-securityDefinitions", "td-vocab-security", "td-vocab-scheme", "td-context-toplevel"];
