...
function tdAssertionReport(inputParam) {
    ...
    if (inputParam === "default" && !myArguments.mergeOnly) {
        inputParam = path.join(path.dirname(corePath), "examples", "tds", "valid")
    }
...
function coreValidation(input) {
    ...
    if (input === "default") { input = path.join(path.dirname(corePath), "examples", "tds") }
...
function tmAssertionReport(inputParam) {
    ...
    if (inputParam === "default") {
        inputParam = path.join(path.dirname(corePath),
            "examples", "tms", "valid")
    }
...
function tmCoreValidation(input) {
    ...
    if (input === "default") { input = path.join(path.dirname(corePath), "examples", "tms") }
    if (fs.lstatSync(input).isDirectory()) {
